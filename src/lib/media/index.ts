...
/**
 * Where the actual bytes live. Local disk today; Azure Blob Storage can drop in
 * behind the same three methods when the site moves to Azure.
 */
...
export const media: MediaStore = localMedia;
