 ...
 * development; an Azure Table Storage driver can implement the same surface
 * later without touching a single component or route handler.
 */
...
export const store: Store = (() => {
  switch (driver) {
    ...
    default:
      throw new Error(
        `Unknown UNINSTAGRAM_STORE driver "${driver}". Supported: json`,
      );
  }
})();
